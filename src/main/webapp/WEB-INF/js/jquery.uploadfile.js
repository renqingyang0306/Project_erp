...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span>拖拽上传</span>",
            uploadStr:"上传",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
            multiDragErrorStr: "不支持多文件拖拽上传。",
            extErrorStr: "不被支持。 支持的格式有: ",
            duplicateErrorStr: "不被允许。文件已经存在。",
            sizeErrorStr: "不被允许。 支持文件的最大长度为: ",
            uploadErrorStr: "上传不被允许。",
            maxFileCountErrorStr: " 不被允许. 最大上传文件数为:",
            downloadStr: "下载",
